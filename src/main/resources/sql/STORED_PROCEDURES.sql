...
DELETE
FROM banks
WHERE bank_id = p_bank_ID LIMIT 1;
END$$
DELIMITER;
...
SELECT *
FROM banks
WHERE bank_details = p_bank_details;
END$$
DELIMITER;
...
DELETE
FROM addresses
WHERE address_id = p_address_id LIMIT 1;
END$$
DELIMITER;
...
BEGIN
DELETE
FROM ref_branch_types
WHERE branch_type_id = p_branch_type_id LIMIT 1;
END$$
DELIMITER;
...
SELECT *
FROM ref_branch_types
WHERE branch_type_code = p_branch_type_code;
END$$
DELIMITER;
...
DELETE
FROM branches
WHERE branch_id = p_branch_id LIMIT 1;
END$$
DELIMITER;
...
WHERE account_type_id = p_account_type_id LIMIT 1;
END$$
DELIMITER;
...
WHERE account_status_id = p_status_type_id LIMIT 1;
END$$
DELIMITER;
...
DELETE
FROM accounts
WHERE account_number = p_account_number LIMIT 1;
END$$
DELIMITER;
...
DELETE
FROM merchants
WHERE merchant_id = p_merchant_id LIMIT 1;
END$$
DELIMITER;
...
WHERE transaction_type_id = p_transaction_type_id LIMIT 1;
END$$
DELIMITER;
...
BEGIN
SELECT *
FROM ref_transaction_types LIMIT
     p_skip,
     p_page_size;
END$$
DELIMITER;
...
IF
EXISTS
`getUserAccountVerificationToken`;
DELIMITER
$$
USE
`bankcentric`
...
IF
EXISTS
`getUserAccountPasswordResetToken`;
DELIMITER
$$
USE
`bankcentric`
...
DELETE
FROM user_role
WHERE user_role.id = p_role_id LIMIT 1;
END$$
DELIMITER;
...
SELECT *
FROM user_role
WHERE user_role.role_name = p_role_name;
END$$
DELIMITER;
...
DELETE
FROM verification_token
WHERE verification_token.id = p_token_id LIMIT 1;
END$$
DELIMITER;
...
IF
EXISTS
`singleVerificationTokenByEmail`;
DELIMITER
$$
USE
`bankcentric`
...
IF
EXISTS
`singleVerificationTokenByToken`;
DELIMITER
$$
USE
`bankcentric`
...
DELETE
FROM password_reset_token
WHERE password_reset_token.id = p_token_id LIMIT 1;
END$$
DELIMITER;
...
IF
EXISTS
`singlePasswordResetTokenByEmail`;
DELIMITER
$$
USE
`bankcentric`
...
IF
EXISTS
`singlePasswordResetTokenByToken`;
DELIMITER
$$
USE
`bankcentric`
