...
CREATE TABLE branches(
    ...
    branch_type_code CHAR(15) NOT NULL, FOREIGN KEY (branch_type_code) REFERENCES ref_branch_types(branch_type_code),
...
-- );
--     
-- CREATE TABLE application_auth_user_group(
-- 	auth_user_group_id BIGINT AUTO_INCREMENT PRIMARY KEY,
--     username VARCHAR(255) NOT NULL, CONSTRAINT user_auth_user_group_fk FOREIGN KEY(username) REFERENCES application_user(user_username),
...
CREATE TABLE verification_token(
	id BIGINT AUTO_INCREMENT PRIMARY KEY,
    token VARCHAR(255),
    user_id BIGINT NOT NULL, CONSTRAINT constr_vt_user_id_fk FOREIGN KEY (user_id) REFERENCES user_account(id),
    expiry_date DATE
);
...
CREATE TABLE password_reset_token(
	id BIGINT AUTO_INCREMENT PRIMARY KEY,
    token VARCHAR(255),
    user_id BIGINT NOT NULL, CONSTRAINT constr_prt_user_id_fk FOREIGN KEY (user_id) REFERENCES user_account(id),
    expiry_date DATE
);